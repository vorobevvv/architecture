...
- Количество слушателей на конференции 
- Количество слушателей на конференции 
- Вовлеченность аудитории (количество активных слушателей) 
- CSI - удовлетворенность сервисом 
- Повторное посещение конференции 
...
|--------|------------------------------|-------------------------------------------|
| QR.001 | *Удобство использования* | *На основании метрики CSI со значением не ниже 4.5 из 5* |
| QR.002 | *Доступность* | *Возможное кол-во слушателей на конференции не менее 10к человек* |
| QR.003 | *Производительность* | *Возможное кол-во активных слушателей не менее 20% от общего числа* |
